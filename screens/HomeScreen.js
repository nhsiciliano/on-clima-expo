            ...
            />
            {
                loading ? (
                    <View className="flex-1 flex justify-center items-center">
                        ...
                        <Text className="text-white text-4xl mt-8">Loading...</Text>
                    </View>
                ) : (
                                    ...
                                    <View className="absolute w-full bg-gray-300 top-16 rounded-xl">
                                        {
                                            locations.map((loc, index) => {
                                                ...
                                                let borderClass = showBorder ? 'border-b-2 border-b-lime-700' : '';
                                                return (
                                                    <TouchableOpacity
                                        ...
                                        return (
                                            ...
                                            >
                                                <Image
                                                    ...
                                                    className="h-12 w-16 my-4"
                                                />
                                                <Text className="text-white mt-2">{dayName}</Text>
